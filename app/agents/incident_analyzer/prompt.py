...
4. Synthesize a concise 'executive_summary' (max 2 sentences, 300 characters).
...
8. Keep the final report concise: include up to 4 key_indicators, keep each indicator reasoning to 1 sentence and 120 characters, and include up to 3 suspicious_payloads with each value under 120 characters.
