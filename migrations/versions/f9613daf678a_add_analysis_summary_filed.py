"""add analysis summary filed

Revision ID: f9613daf678a
Revises: 7c2f6d8a91b4
Create Date: 2026-05-03 18:10:19.253825
...
revision: str = 'f9613daf678a'
down_revision: Union[str, Sequence[str], None] = '7c2f6d8a91b4'
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('incidents', sa.Column('executive_summary', sa.TEXT(), autoincrement=False, nullable=True))
